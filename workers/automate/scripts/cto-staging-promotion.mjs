...
const DEFAULT_KNOWN_AGENT_LOGINS = 'external-coding-agent,external-coding-agent,external-agent';
const DEFAULT_QA_APPROVED_LABEL = 'agent:qa:accepted';
const DEFAULT_SECURITY_APPROVED_LABEL = 'agent:security:accepted';
