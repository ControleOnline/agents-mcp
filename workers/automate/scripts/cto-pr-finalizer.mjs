...
const QA_ACCEPTED_LABELS = ['agent:qa:accepted'];
const QA_REJECTED_LABELS = ['agent:qa:rejected'];
const SECURITY_ACCEPTED_LABELS = ['agent:security:accepted'];
const SECURITY_REJECTED_LABELS = ['agent:security:rejected'];
