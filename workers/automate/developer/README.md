...
- workflow de compatibilidade: `workers/automate/workflows/developer-project-dispatch.yml`
- runner comum: `workers/src/agent-dispatch-runner.js`
- wrapper do papel: `workers/automate/agents/developer/dispatch.mjs`
- logica compartilhada final: `workers/automate/scripts/agent-project-dispatch.mjs`
