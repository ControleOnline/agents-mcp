...
- entry point de runtime: `workers/src/developer-runner.js`
- logica final atual: `workers/automate/scripts/developer-pr-dispatch.mjs`
...
- entry point de runtime: `workers/src/cto-runner.js`
- logica final de supervisao: `workers/automate/scripts/cto-project-supervisor.mjs`
- logica final de aprovacao exclusiva: `workers/automate/scripts/cto-pr-finalizer.mjs`
...
- entry point de runtime: `workers/src/devops-runner.js`
