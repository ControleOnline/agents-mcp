...
1. leia este arquivo
2. leia `agents/roles/devops/agent.md`
3. leia os materiais operacionais já existentes em:
   - `workers/automate/devops/README.md`
   - `workers/automate/devops/direct-push-ingest.mjs`
   - `.github/workflows/direct-push-ingest.yml`, quando aplicável
4. quando o pedido for publicar um repositório em `master`, leia `agents/skills/shared/github/master-publication.md`
...
- quando o pedido for publicacao em `master`, aplique `agents/skills/shared/github/master-publication.md`
