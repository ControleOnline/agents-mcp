...
Este é o ponto de entrada canônico do agent `full-pipeline` para o ecossistema ControleOnline.

## Como usar

Todo wrapper local ou automação do Full Pipeline deve apontar para este arquivo.
