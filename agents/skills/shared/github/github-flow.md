...
Detalhes de publicacao em `master`: `agents/skills/shared/github/master-publication.md`.
...
- criacao de issue/backlog: `agents/skills/by-role/cto/github-backlog-task-creation.md`
- criterios de conclusao de etapa: `agents/skills/shared/quality/task-completion-criteria.md`
- publicacao em master: `agents/skills/shared/github/master-publication.md`
- hotfix a partir de master: `agents/skills/shared/github/operational-github-workflow.md`
- ownership e handoff: `agents/skills/shared/operations/agent-handoff-governance.md` e `AGENTS.md`
