...
- `agents/skills/paperclip/shared-operations-agent-wrapper-contract/SKILL.md`
- `agents/skills/paperclip/shared-operations-agent-handoff-governance/SKILL.md`

## Skills exclusivas

- `agents/skills/paperclip/by-role-cto-github-backlog-task-creation/SKILL.md`: intake tecnico de URLs, telas e escopos, com criacao de issues e inclusao confirmada no backlog do ProjectV2
...
- nenhuma acao operacional ou estrutural deve comecar sem task valida; quando a solicitacao chegar sem task, o CTO primeiro cria uma ou mais issues com `agents/skills/paperclip/by-role-cto-github-backlog-task-creation/SKILL.md` e so depois executa
