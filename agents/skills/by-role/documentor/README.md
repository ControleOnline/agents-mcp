...
> Arquivo legado de compatibilidade. A versao canonica agora e `agents/skills/by-role/tutorial-assistant/README.md`.
...
- faca commit apenas de mudancas operacionais em workers/scripts/instrucoes quando houver ajuste real de processo
