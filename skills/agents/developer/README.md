...
- branch de trabalho derivada de `master` (ver `skills/shared/github-flow.md`)
...
- siga `skills/shared/github-flow.md` para branching, sincronizacao com `master` e entrega em `staging`
